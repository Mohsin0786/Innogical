  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8000/postsnippet', requestOptions)
      ...
      .then(resdata => {
        setClassCodes([
          ...classCodes,
          { projectName: resdata.message.projectName, _id: resdata.message._id, language: resdata.message.language }
        ])
        history.push("/" +resdata.message.language +"/"+ resdata.message._id);
      })
    setopenSignIn(false)
  }
  let name, value;
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} >
            ...
            >
              ...
              <MenuItem value={"cpp"} className={classes.menu}>C++</MenuItem>
...
function Content({ setopenSignIn }) {
  ...
  return (
    <div className="content" style={{
      ...
      <div className="select-section" style={{
        justifyContent: 'center',
        display: 'flex'
      }}>
        <div className="select-project" style={{
...
export default function Dashboard({ openSignIn, setopenSignIn,setClassCodes,classCodes }) {
  return (
    <div style={{ height: '100vh' }}>
      <Content setopenSignIn={setopenSignIn} />
      <ModalBox openSignIn={openSignIn} setopenSignIn={setopenSignIn} setClassCodes={setClassCodes} classCodes={classCodes} />
    </div>
  )
}
