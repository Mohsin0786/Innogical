...
function Playground() {
  ...
  return (
    <div className="App">
      ...
      <div className="editor-container" style={{ display: "flex" }}>
        ...
        <div className="editor-field">
          <textarea className="textContent" rows="40" cols="150" ref={nameInput} style={{
            resize: 'none',
            margin: '0px',
            width: '978px',
            height: '540px',
        ...
        <div className="compilor-field" style={{
          display: 'flex',
    width: '63%',
    ...
    justifyContent: 'center'
          ...
          <div onClick={getdata} style={{ position: 'absolute',
    top: '39rem',
 ...
 <div onClick={saveData} style={{ position: 'absolute',
    top: '39rem',
    border: '1px solid black',
    width: '5rem',
    height: '2.4rem',
